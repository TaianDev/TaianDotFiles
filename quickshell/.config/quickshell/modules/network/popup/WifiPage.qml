            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    MouseArea {
                        id: bgMa
                        anchors.fill: parent
                        hoverEnabled: !root.refreshing
                        cursorShape: Qt.PointingHandCursor
                        onClicked: {
                            if (root.refreshing || model.active || isConnecting) return
                            root.errorSsid = ""
        ...
        Column {
            ...
            Item {
                ...
                Image {
                    id: refreshIcn
                    anchors.fill: parent
                    source: root.iconsPath + "refresh.svg"
                    visible: false
                }
                ColorOverlay {
                    anchors.fill: refreshIcn
                    source: refreshIcn
                    color: Theme.primary
                }
