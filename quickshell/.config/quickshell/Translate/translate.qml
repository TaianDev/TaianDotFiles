...
PanelWindow {
    ...
    Process {
        ...
        command: [ 
            ...
            getLangCode(sourceLanguageSelector.currentText), // Source language code
            getLangCode(targetLanguageSelector.currentText), // Target language code
            getEngineCode(translationEngineSelector.currentText), // Engine code
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        text: "⇄"
                        font.pixelSize: languageSwitcher.height * 0.5
                    }
                    MouseArea {
                        id: switcherLanguageButton
                        anchors.fill: parent
                        enabled: !backendTraductor.running
                        onClicked: {
                            backendTraductor.running = false
                            textToTranslateArea.text = "Translating..."
                            backendTraductor.running = true
                        }
                    }
                }
