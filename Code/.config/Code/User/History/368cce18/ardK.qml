...
PopupWindow {
    ...
    // ════════════════════════════════════════════════════════════
    //  Carátula estable (soluciona Firefox + cambio de reproductor)
    // ════════════════════════════════════════════════════════════
    ...
    property var    lastPlayer:   null   // ← Para detectar cambio de reproductor

    // Reiniciamos la carátula solo cuando el reproductor (objeto) cambia realmente
    onPlayerChanged: {
