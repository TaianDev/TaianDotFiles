...
PopupWindow {
    ...
    function refreshArtCache() {
        // Si la pista no ha cambiado y ya tenemos una imagen en caché, no recargamos
        if (trackId !== "" && trackId === cachedTrackId && cachedGrab && cachedGrab.url !== "") {
            return
        }
        // Nueva pista o sin caché → limpiamos y cargamos la nueva URL (si existe)
        cachedGrab = null
        ...
        Rectangle {
            ...
            Item {
                ...
                Image {
                    ...
                    cache: false
                    asynchronous: true
                    sourceSize.width: 150   // Tamaño reducido para blur más rápido
