...
PopupWindow {
    ...
    // ════════════════════════════════════════════════════════════
    // Cache de carátulas POR PLAYER — evita sobreescritura
    ...
    // Cuando cambia el player (cacheKey), NO tocar artCache
    // stableArtUrl se recalcula automáticamente desde artCache[cacheKey]
    // Si el nuevo player no tiene entrada en caché aún, mostrará ""
    // hasta que artUrl llegue y se guarde
