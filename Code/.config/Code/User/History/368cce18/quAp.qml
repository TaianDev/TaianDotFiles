...
PopupWindow {
    ...
    // ── Índice del reproductor activo (para limpiar al cambiar) ──
    readonly property int activePlayerIndex: widgetRef?.activePlayerIndex ?? 0

    onActivePlayerIndexChanged: {
        // Al cambiar de reproductor, borramos cualquier carátula anterior
        stableArtUrl = ""
        lastTrackId = ""
    }

    // ════════════════════════════════════════════════════════════
    //  Carátula estable (soluciona el bug de Firefox + cambio reproductor)
    // ════════════════════════════════════════════════════════════
