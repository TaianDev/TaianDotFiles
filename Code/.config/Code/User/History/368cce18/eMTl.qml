...
PopupWindow {
    ...
    // Timer más rápido para una barra de progreso más fluida
    Timer {
    ...
    Item {
        ...
        Rectangle {
            ...
            Item {
                anchors.fill: parent
                visible: popup.actualArtUrl !== ""

                Image {
                    id: popupBg
                    anchors.centerIn: parent
                    source: popup.actualArtUrl
                    width:  parent.width  + 60
                    height: parent.height + 60
                    fillMode: Image.PreserveAspectCrop
                    cache: true          // ← Activado
                    asynchronous: true
                    sourceSize.width: 200   // ← Reducido para rendimiento
            ...
            Column {
                ...
                Item {
                    ...
                    Image {
                        id: artIn
                        width: parent.width; height: parent.height
                        source: popup.actualArtUrl   // ← Usa el fallback de Firefox
                        fillMode: Image.PreserveAspectFit
                        ...
                        NumberAnimation on x {
                            ...
                            duration: 280; easing.type: Easing.OutCubic   // ← Más rápido
                        }
                    }
                    ...
                    Rectangle {
                        ...
                        visible: popup.actualArtUrl === "" || artIn.status === Image.Error
