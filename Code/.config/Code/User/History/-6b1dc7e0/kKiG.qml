...
Item {
    ...
    height: 28 // Misma altura que tus workspaces
    ...
    MprisMenu {
        ...
        anchor.window: flareBar // Conecta a la barra actual
        anchor.on: root
        anchor.edges: AnchorEdge.Bottom
        anchor.margins.bottom: 10 // Separación de la barra
    }
}