...
Item {
    ...
    // ── 1. Escáner de Estado (A prueba del idioma del sistema) ──
    Process {
        id: statusScanner
        command: [
            "bash", "-c",
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            NetworkToggle {
                title: "Wi-Fi"
                // Lógica de texto estilo iOS
                subtitle: root.wifiEnabled 
                          ? (root.wifiNetwork !== "" ? root.wifiNetwork : "Encendido") 
                          : "Apagado"
            ...
            NetworkToggle {
                ...
                subtitle: root.btEnabled 
                          ? (root.btDeviceName !== "" ? root.btDeviceName : "Encendido") 
                          : "Apagado"
