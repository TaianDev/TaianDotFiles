...
Item {
    ...
    ColumnLayout {
        ...
        // Layout.fillWidth: true; Layout.topMargin: 4; Layout.rightMargin: 15; Layout.leftMargin: 15; spacing: 14
        // 3. Sliders de Sistema
// 3. Sliders de Sistema (Corregidos para permitir arrastre)
        ColumnLayout {
            Layout.fillWidth: true; Layout.topMargin: 4; spacing: 14
            ...
            // 🌟 Protege el arrastre del Brillo de interferencias externas
            Binding { target: brightSlider; property: "value"; value: root.sysBright; when: !brightSlider.isDragging }
            ...
            // 🌟 Protege el arrastre del Volumen
            Binding { target: volSlider; property: "value"; value: root.sysVol; when: !volSlider.isDragging }
            ...
            // 🌟 Protege el arrastre del Micrófono
            Binding { target: micSlider; property: "value"; value: root.sysMic; when: !micSlider.isDragging }
        }
