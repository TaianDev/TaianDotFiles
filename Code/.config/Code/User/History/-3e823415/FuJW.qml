...
Item {
    id: root
    width: 320
    height: 440 // 🌟 Altura ajustada para alojar los botones de energía
    ...
    // ── 1. Súper Escáner (Ahora lee muteos de wpctl) ──
    Process {
        id: statusScanner
        command: [
            "bash", "-c",
    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            Repeater {
                model: powerModel
                Rectangle {
                    width: 44; height: 44; radius: 22 // Círculos perfectos
