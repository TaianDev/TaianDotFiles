...
Item {
    ...
    // ── Carátula estable (soluciona el bug de Firefox/Zen + cambio de reproductor) ───
    ...
    // Cada vez que cambiamos de reproductor, limpiamos la carátula antigua
    onActivePlayerIndexChanged: {
        stableArtUrl = ""
        lastTrackId = ""  // Así evitamos que onArtUrlChanged retenga algo no deseado
    }
