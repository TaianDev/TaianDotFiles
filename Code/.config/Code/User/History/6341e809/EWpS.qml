...
Item {
    ...
    // 🔄 Arranque suave: solo inicia si no está corriendo
    onVisibleChanged: {
        if (visible) {
            if (!savedScanner.running) savedScanner.start()
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if (!connector.running) connector.start()
                        }
                    }
                        ...
                        Rectangle {
                            ...
                            MouseArea {
                                ...
                                onClicked: {
                                    ...
                                    if (!forgetter.running) forgetter.start()
                                }
                            }
                        }
                    }
