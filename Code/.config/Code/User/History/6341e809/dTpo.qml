...
Item {
    ...
    // ── UI ────────────────────────────────────────────────────
    // El foco se maneja directamente sin FocusScope raíz
    ScrollView {
        anchors.fill: parent
        contentWidth: availableWidth
        clip: true
        ScrollBar.vertical.policy: ScrollBar.AlwaysOff
        focus: false   // no roba foco
        ...
        ListView {
            ...
            spacing: 4
            focus: false
            keyNavigationEnabled: false   // no captura eventos de teclado
            ...
            delegate: Item {
                ...
                Rectangle {
                    ...
                    Item {
                        ...
                        // Timer para dar foco después de la animación de expansión
                        Timer {
                            id: focusTimer
                            interval: 250
                            repeat: false
                            onTriggered: {
                                // fuerza el foco directamente en el TextField
                        ...
                        RowLayout {
                            ...
                            // TextField sin FocusScope extra
                            TextField {
                                id: passField
                                Layout.fillWidth: true
