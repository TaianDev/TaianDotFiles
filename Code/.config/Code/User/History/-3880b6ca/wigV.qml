    ...
    Item {
        ...
        RowLayout {
            ...
            Rectangle { 
                ...
                MouseArea { 
                    anchors.fill: parent
                    onClicked: { root.tmRunning = false; root.tmActive = false; root.tmTotalSecs = 0; root.showTmControls = false } 
                } 
            }
