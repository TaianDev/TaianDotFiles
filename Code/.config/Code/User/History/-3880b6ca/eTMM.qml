...
Rectangle {
    ...
    Item {
            ...
            RowLayout {
                ...
                Rectangle {
                    ...
                    SequentialAnimation {
                        ...
                        // Al pausar o cambiar de estado, se fuerza a retornar a opacidad total
                ...
                Item {
                    ...
                    SequentialAnimation {
                        ...
                        // Previene que el icono quede congelado transparente al pausarse
        ...
        RowLayout {
            ...
            Image { source: root.iconsPath + "sand-clock.svg"; Layout.preferredWidth: 14; Layout.preferredHeight: 14; sourceSize.width: 14; sourceSize.height: 14; fillMode: Image.PreserveAspectFit; layer.enabled: true; layer.effect: ColorOverlay { color: "#ffffff" } }
        ...
        RowLayout {
            ...
            Image { source: root.iconsPath + "end-clock.svg"; Layout.preferredWidth: 16; Layout.preferredHeight: 16; sourceSize.width: 16; sourceSize.height: 16; fillMode: Image.PreserveAspectFit; layer.enabled: true; layer.effect: ColorOverlay { color: "#ffffff" } }
