...
Rectangle {
    ...
    MouseArea {
        ...
        onPositionChanged: (mouse) => {
            // Si arrastras más de 40px a la derecha, navegas entre las instancias activas
            if (!dragDetected && (mouse.x - startX > 40)) {
                ...
                if (swIsActive && root.tmActive) {
                    ...
                    // Si los controles estaban expandidos, hace el cambio de controles al vuelo
        ...
        onClicked: (mouse) => {
            ...
            if (mouse.button === Qt.RightButton) {
                ...
                // Click Izquierdo: Entrar/Expandir controles de la instancia seleccionada
    ...
    Item {
        ...
        RowLayout {
            ...
            // Indicador dinámico según instancia activa en background
            RowLayout {
                spacing: 6
        ...
        RowLayout {
            ...
            Rectangle {
                width: 8; height: 8; radius: 4; color: "#e06c75"
                SequentialAnimation on opacity { running: root.swRunning && root.currentViewState === "stopwatch"; loops: Animation.Infinite; NumberAnimation { from: 1; to: 0.2; duration: 600 }; NumberAnimation { from: 0.2; to: 1; duration: 600 } }
            }
            Text { text: root.formatPillSW(root.swElapsedMs); color: "#ffffff"; font.pixelSize: 14; font.bold: true; font.family: "monospace" }
            Rectangle { width: 24; height: 24; radius: 6; color: Qt.rgba(1,1,1,0.1); Text { anchors.centerIn: parent; text: "🗑"; color: "#ffffff"; font.pixelSize: 11 }; MouseArea { anchors.fill: parent; onClicked: { root.swRunning = false; root.swElapsedMs = 0; root.showSwControls = false } } }
            Rectangle { width: 24; height: 24; radius: 6; color: Qt.rgba(224/255, 108/255, 117/255, 0.2); Text { anchors.centerIn: parent; text: root.swRunning ? "⏸" : "▶"; color: "#e06c75"; font.pixelSize: 11 }; MouseArea { anchors.fill: parent; onClicked: root.swRunning = !root.swRunning } }
        }
        ...
        RowLayout {
            ...
            Image { source: root.iconsPath + "sand-clock.svg"; width: 14; height: 14; fillMode: Image.PreserveAspectFit }
            Text { text: root.formatPillTM(root.tmTotalSecs); color: "#ffffff"; font.pixelSize: 14; font.bold: true; font.family: "monospace" }
            Rectangle { width: 24; height: 24; radius: 6; color: Qt.rgba(1,1,1,0.1); Text { anchors.centerIn: parent; text: "✕"; color: "#ffffff"; font.pixelSize: 11 }; MouseArea { anchors.fill: parent; onClicked: { root.tmRunning = false; root.tmActive = false; root.tmTotalSecs = 0; root.showTmControls = false } } }
            Rectangle { width: 24; height: 24; radius: 6; color: Qt.rgba(180/255, 219/255, 146/255, 0.2); Text { anchors.centerIn: parent; text: root.tmRunning ? "⏸" : "▶"; color: "#b4db92"; font.pixelSize: 11 }; MouseArea { anchors.fill: parent; onClicked: root.tmRunning = !root.tmRunning } }
        }
        ...
        RowLayout {
            ...
            Image { source: root.iconsPath + "end-clock.svg"; width: 16; height: 16; fillMode: Image.PreserveAspectFit }
            Text { text: "Time's up!"; color: "#e06c75"; font.pixelSize: 14; font.bold: true }
        }
    }
