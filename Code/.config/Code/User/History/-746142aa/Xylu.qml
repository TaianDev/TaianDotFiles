...
PanelWindow {
    ...
    // Foco de teclado dinámico para Wayland
    ...
    // 🌟 Visibilidad perfecta: Se mantiene vivo mientras la animación de salida esté corriendo
    ...
    Item {
        ...
        Behavior on y { 
            NumberAnimation { 
                id: slideAnim // Este ID controla la visibilidad de la ventana
                duration: 350
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    // Controles de teclado perfectos
                    Keys.onUpPressed: {
                ...
                ListView {
                    ...
                    spacing: 6
                    currentIndex: -1
                    interactive: false // Desactiva el scroll con el ratón
                    ...
                    delegate: Rectangle {
                        ...
                        RowLayout {
                            ...
                            // 🌟 Imagen nativa (Colores originales)
                            Image {
                        ...
                        // Área de ratón restituida para que también puedas usar el mouse si quieres
                        MouseArea {
                            id: itemMa
                            anchors.fill: parent
                            hoverEnabled: true
        ...
        // Esquina Cóncava Izquierda (Fondo sólido + Borde brillante exacto)
        Shape {
            anchors.bottom: parent.bottom
        ...
        // Esquina Cóncava Derecha (Fondo sólido + Borde brillante exacto)
        Shape {
            anchors.bottom: parent.bottom
