...
PanelWindow {
    ...
    // Anclamos nativamente al fondo abarcando todo el ancho para poder centrarlo
    anchors {
        bottom: true
        left: true
        right: true
    ...
    exclusiveZone: 0 // No roba espacio de las ventanas maximizadas
    ...
    // 🌟 MAGIA DE WAYLAND: La ventana solo se renderiza mientras sea opaca
    ...
    Item {
        ...
        Rectangle {
            ...
            anchors.horizontalCenter: parent.horizontalCenter // Lo centra en la pantalla
            radius: 20
