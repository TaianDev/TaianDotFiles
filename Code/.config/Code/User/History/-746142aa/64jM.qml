...
PanelWindow {
    ...
    // 🌟 CORRECCIÓN 1: Exigimos el foco del teclado a Wayland SOLO cuando se abre
    ...
    onIsOpenedChanged: {
        if (isOpened) {
            searchInput.text = ""
            // Le damos el foco a la barra de búsqueda inmediatamente
    ...
    Item {
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        RowLayout {
                            ...
                            // 🌟 CORRECCIÓN 2: IconImage preserva los colores nativos de tus iconos
                            IconImage {
        ...
        // 🌟 CORRECCIÓN 3: Esquina Cóncava Izquierda (Fondo + Borde exacto)
        Shape {
            anchors.bottom: parent.bottom
            ...
            // Trazo 1: El relleno oscuro (sin bordes)
            ShapePath {
            ...
            // Trazo 2: Solo la línea curva brillante simulando el borde
            ShapePath {
        ...
        // 🌟 CORRECCIÓN 3: Esquina Cóncava Derecha (Fondo + Borde exacto)
        Shape {
            anchors.bottom: parent.bottom
