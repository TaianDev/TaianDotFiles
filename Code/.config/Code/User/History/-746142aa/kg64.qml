...
PanelWindow {
    ...
    // 🌟 LA MAGIA: Solo es visible si está abierto O si la animación de salida sigue en curso
    ...
    Item {
        ...
        // Animación Slide: Sube a 0 al abrir, Baja a 500 al cerrar
        y: launcherPopup.isOpened ? 0 : launcherPopup.implicitHeight
        
        Behavior on y { 
            NumberAnimation { 
                id: slideAnim // Le damos un ID para rastrear cuándo termina de moverse
                duration: 350
                easing.type: Easing.OutQuart 
            } 
        }

        // Un pequeño desvanecimiento (fade) ayuda a evitar parpadeos nativos de Wayland
        opacity: launcherPopup.isOpened ? 1 : 0
        Behavior on opacity { NumberAnimation { duration: 250 } }

        Rectangle {
            id: mainBody
            // ... (A PARTIR DE AQUÍ TODO TU CÓDIGO SE MANTIENE EXACTAMENTE IGUAL) ...
            width: 600
            ...
            Rectangle {
                anchors.bottom: parent.bottom
        opacity: 1 //launcherPopup.isOpened ? 1 : 0
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                TextField {
                    ...
                    font.pixelSize: 15
                    activeFocusOnPress: false   // ← evita que el ratón robe el foco
                ...
                ListView {
                    ...
                    spacing: 6
                    currentIndex: -1
                    interactive: false              // ← el ratón no puede hacer scroll
                    ScrollBar.vertical: ScrollBar { policy: ScrollBar.AlwaysOff }  // innecesario ya que no se usa el ratón
                    ...
                    delegate: Rectangle {
                        ...
                        color: isSelected ? Qt.rgba(0.97, 0.88, 0.68, 0.15) : "transparent"
                        // Sin hover, sin MouseArea
