...
PanelWindow {
    ...
    Process {
        ...
        running: true 
        onStdout: (text_parse) => {
            principalPanel.textToTranslate = text_parse
    ...
    Process {
        id: backendTraductor
        running: true
        command: [ "bash", "-c", "~/.config/quickshell/Translate/scripts/translate.sh", "", "", "principalPanel.textToTranslate" ]
        onStdout: (translation) => {
            textToTranslateArea.text = translation
        }
    }
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                TextArea {
                    ...
                    placeholderText: "Here's the translation :)"
                    text: ""
                }
            }
        }
