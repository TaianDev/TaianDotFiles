...
if __name__ == "__main__":
    ...
    ## 2) Apply Box-Cox transformation to the loaded series and obtain the optimal lambda
    transformed_serie, optimal_lambda = core_transformer.boxcox_transform(load_serie)

    ## 3) Perform the Augmented Dickey-Fuller test to determine the order of differencing (d) needed for stationarity, and obtain the stationary series
