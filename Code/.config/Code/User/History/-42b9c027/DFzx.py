...
if __name__ == "__main__":
    ...
    if not 0 <= optimal_lambda <=1:
        print("[!] Remember to interpret the results in the context of the Box-Cox transformation applied, accepting values round 1.0 (no transformation) and 0.5 (square root) as common cases.")
