...
import Quickshell.Wayland.Anchor    // <-- necesario para Anchor.Top, etc.
...
PopupWindow {
    ...
    anchor {
        ...
        // Posición fija respecto al borde derecho y superior
        rect: Qt.rect(
            popup.hostWindow ? popup.hostWindow.width - 380 : 0,
            40,
            popup.implicitWidth,
            popup.implicitHeight
        )
        edges: Anchor.Top | Anchor.Right   // ← corregido
    }
