...
hl.bind(mainMod .. " + Z",         hl.dsp.exec_cmd(terminal .. "clipse", { float = true, size = { width = 0.35, height = 0.4 }})) -- HERE
...
hl.bind(mainMod .. " + SHIFT + left",  hl.dsp.window.resize({ x = -20, y = 0}), { repeating = true })
hl.bind(mainMod .. " + SHIFT + right", hl.dsp.window.resize({ x = 20,  y = 0}), { repeating = true })
